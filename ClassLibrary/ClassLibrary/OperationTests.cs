...
using ClassLibrary.ElasticSearchAdapter;
using Xunit;
...
namespace ClassLibrary
{
    ...
    {
        private static readonly string DataDResultTxtF = EnvManager.Ase.GetDataD() + "/OperationTests.res.txt";
...
//        }
        ...
        public void mkidx_test()
        {
            ...
            var tweets = EsOperation.EsWriteAndReadbackTweet(pTweet);
